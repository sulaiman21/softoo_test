...
describe("CartPage", () => {
	...
	test("should render No Items when there is no cart items", async () => {
		render(
	...
	test("onClick on 'removeItemBtn', should remove item from cart", () => {
		render(
			<Provider store={store}>
				<CartPage />
			</Provider>
	...
	test("onClick on 'addCartItem', should add item from cart", () => {
		render(
			<Provider store={store}>
				<CartPage />
			</Provider>
